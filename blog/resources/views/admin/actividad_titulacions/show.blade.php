        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel-panel-default">
                <div class="panel-heading">
                    Ver Actividades de Titulación

                </div>
            
                <div class="panel-body">
                    <p><strong>Nombre:</strong>   {{ $actividad_titulacion->nombre }} </p>
                    <p><strong>Duracion:</strong> {{ $actividad_titulacion->duracion }} </p>
                    <p><strong>Comision:</strong>   {{ $actividad_titulacion->comision }} </p>
                    <p><strong>Cantidad de Estudiantes:</strong>   {{ $actividad_titulacion->cant_estudiante }} </p>
                </div>
            </div>
        </div>
    </div>
